    ...
    var n, r = n = function() {
        ...
        function() {
            ...
            t.dom.extend({
                ...
                if (e.size() <= 0="" 1="" 0)="" return="" e;="" switch="" (t.type(n))="" {="" case="" "string":="" if="" (r="==" undefined)="" i.call(e,="" e[0],="" n);="" e.each(function(o,="" u)="" u,="" n,="" t.type(r)="==" "function"="" ?="" r.call(u,="" o,="" n))="" :="" r,="" s)="" });="" break;="" "object":="" for="" (var="" o="" in="" n)="" t._util_.access(e,="" n[o],="" i,="" r)="" }="" e="" },="" t._util_.nodename="function(e," t)="" e.nodename="" &&="" e.nodename.tolowercase()="==" t.tolowercase()="" t._util_.propfixer="{" tabindex:="" "tabindex",="" readonly:="" "readonly",="" "for":="" "htmlfor",="" "class":="" "classname",="" classname:="" maxlength:="" "maxlength",="" cellspacing:="" "cellspacing",="" cellpadding:="" "cellpadding",="" rowspan:="" "rowspan",="" colspan:="" "colspan",="" usemap:="" "usemap",="" frameborder:="" "frameborder",="" contenteditable:="" "contenteditable",="" rboolean:="" ^(?:autofocus|autoplay|async|checked|controls|defer|disabled|hidden|loop|multiple|open|readonly|required|scoped|selected)$="" i="" !document.createelement("form").enctype="" (t._util_.propfixer.enctype="encoding" ),="" t._util_.prop="function()" var="" n="/^a(?:rea|)$/i," r="document.createElement("select")," s="{" get:="" function(t)="" r.specified="" parseint(r.value,="" 10)="" e.test(t.nodename)="" ||="" n.test(t.nodename)="" t.href="" undefined="" };="" !="" i.selected="" (s.selected="{" function(e)="" t="e.parentNode;" (t.selectedindex,="" t.parentnode="" t.parentnode.selectedindex),="" null="" }),="" =="" null,="" function(e,="" u;="" (!e="" ~"238".indexof(i))="" return;="" (i="" !t._util_.isxml(e))="" {};="" o.set="" (u="o.set(e," r))="" u:="" e[n]="r:" o.get="" (),="" t._util_.support.getsetattribute="t._util_.support.dom.div.className" "t",="" t._util_.nodehook="function()" (t._util_.support.getsetattribute)="" e.name="e.id" e.coords="!0," function(t,="" (e[n]="" r.value="" "":="" r.specified)="" r.value:="" set:="" t,="" e.setattributenode(r)),="" +="" ""="" t._util_.removeattr="function()" function(i,="" (!s="" i.nodetype="" 1)="" a;="" f="0," l;="" l="o[f];" f++)="" u="e[l]" l,="" a="e.rboolean.test(l)," !a="" t._util_.attr(i,="" ""),="" i.removeattribute(r="" l:="" u),="" (i[u]="!1)" t._util_.attr="function()" "="" a",="" "class"="" n),="" i;="" !0="" typeof="" i.nodevalue="" !1="" n.tolowercase()="" !1)="" e.removeattr(t,="" else="" n;="" (t[i]="!0)," t.setattribute(n,="" n.tolowercase())="" type:="" (n.test(t.nodename)="" t.parentnode)="" s;="" (!i="" "radio"="" e.nodename(t,="" "input"))="" t.setattribute("type",="" s),="" (t.value="o)," value:="" "button")="" u.get(t,="" t.value:="" "button"))="" u.set(t,="" r);="" t.value="r" e.support.getsetattribute="" (t.foreach(["width",="" "height"],="" l[e]="{" (n="==" "")="" e.setattribute(t,="" "auto"),="" l.contenteditable="{" u.get,="" u.set(e,="" t.foreach(["href",="" "src",="" "width",="" 2);="" undefined:="" (l.style="{" e.style.csstext.tolowercase()="" e.style.csstext="n" function(n,="" c="o" !e.isxml(n),="" h,="" p;="" (!n="" ~"238".indexof(o))="" (s="" t.dom.fn[r])="" t.dom(n)[r](i);="" r.tolowercase(),="" h="l[r]" (e.propfixer.rboolean.test(r)="" f:="" u));="" null)="" e.removeattr(n,="" h.set="" (p="h.set(n," i))="" p:="" (n.setattribute(r,="" i)="" h.get="" p="==" p)="" t.dom.extend({="" attr:="" t._util_.access(this,="" e,="" t._util_.attr(e,="" })="" before:="" function()="" t.check("^(?:string|function|htmlelement|\\$dom)(?:,(?:string|array|htmlelement|\\$dom))*$",="" "baidu.dom.before"),="" t._util_.smartinsert(this,="" arguments,="" this.parentnode="" this.parentnode.insertbefore(e,="" this)="" this="" bind:="" this.on(e,="" undefined,="" t.dom.match="function()" function="" r(e)="" while="" (e="e.parentNode)" e.nodetype="" t.push(e);="" -="" 1;=""> -1; n--) if (t[n].nodeType == 1 || t[n].nodeType == 9) return t[n];
                    return null
                }
                var e = /^[\w\#\-\$\.\*]+$/,
            ...
            t.dom.extend({
                getWindow: function() {
                    ...
                    return this.size() <= 0="" ?="" undefined:="" e.parentwindow="" ||="" e.defaultview="" }="" }),="" t.dom.extend({="" offsetparent:="" function()="" {="" return="" this.map(function()="" var="" e="this.offsetParent" document.body,="" n="/^(?:body|html)$/i;" while="" (e="" &&="" t.dom(e).getcurrentstyle("position")="==" "static"="" !n.test(e.nodename))="" })="" position:="" if="" (this.size()="" <="0)" 0;="" t="this.offset()," r="e.test(n[0].nodeName)" left:="" 0,="" top:="" }:="" n.offset();="" t.left="" -="parseFloat(this.getCurrentStyle("marginLeft"))" t.top="" r.left="" +="parseFloat(n.getCurrentStyle("borderLeftWidth"))" r.top="" r.left,="" offset:="" function="" e(e,="" n,="" r)="" i="i" =="" t.dom(e),="" s="i.getCurrentStyle("position");" (e.style.position="relative" );="" o="i.offset()," u="i.getCurrentStyle("left")," a="i.getCurrentStyle("top")," f="~"absolute|fixed".indexOf(s)" ~="" (""="" a).indexof("auto"),="" l="f" i.position();="" l.left="" parsefloat(u)="" l.top="" parsefloat(a)="" t.type("options")="==" "function"="" (n="n.call(e," r,="" o)),="" n.left="" !="undefined" (e.style.left="n.left" o.left="" "px"),="" n.top="" (e.style.top="n.top" o.top="" "px")="" function(n)="" (n)="" t.check("^(?:object|function)$",="" "baidu.dom.offset");="" for="" (var="" i;="" r++)="" e(i,="" r);="" this="" },="" a,="" f;="" (!o)="" return;="" t._util_.contains(f,="" s)="" (typeof="" s.getboundingclientrect="" (u="s.getBoundingClientRect())," u.left="" (a.pagexoffset="" f.scrollleft)="" (f.clientleft="" 0),="" u.top="" (a.pageyoffset="" f.scrolltop)="" (f.clienttop="" 0)="" :="" ()="" has:="" function(e)="" t.foreach(this,="" function(t)="" r[0]="t," r.find(e).length="" n.push(t)="" t.dom(n)="" hasclass:="" (arguments.length="" typeof="" "function")="" this;="" 1;="" "").replace(="" \s+$="" g,="" \s+="" "="" ");="" "),="" r;="" n.length;="" i++)="" (!~="" ("="" ").indexof("="" n[i]="" "))="" (r="" !1)="" t._util_.getwindowordocumentwidthorheight="t._util_.getWindowOrDocumentWidthOrHeight" window:="" {},="" document:="" {}="" };="" t.foreach(["width",="" "height"],="" n;="" e.window["get"="" n]="function(e)" t.browser.isstrict="" n.body="" n.body[r]="" e.document["get"="" t[r]="">= t[s] ? t[r] : Math.max(e.body[s], t[s], e.body[i], t[i])
                    }
                }),
                function(t, n, r) {
            ...
            t.dom.extend({
                ...
                text: function(e) {
                    ...
                    i = !1,
                    s;
                    if (this.size() <= 0="" 1="" 2="" 3="" 9="" 0)="" switch="" (typeof="" e)="" {="" case="" "undefined":="" return="" undefined;="" default:="" r="" }="" var="" o="function(e)" t,="" n="" ,="" i="e.nodeType;" if="" (i)="" (i="==" ||="" 11)="" e.textcontent="=" "string")="" e.textcontent;="" for="" (e="e.firstChild;" e;="" e="e.nextSibling)" +="o(e)" else="" 4)="" e.nodevalue;="" };="" t.foreach(r,="" function(t,="" r)="" u="n(t);" (s)="" return;="" s="o(t)," s;="" "number":="" "string":="" u.empty().append((t="" &&="" t.ownerdocument="" document).createtextnode(e));="" break;="" "function":="" u.text(e.call(t,="" r,="" u.text()))="" }),="" ?="" r:="" t.dom.extend({="" toggle:="" function()="" (var="" t="this.size();" <="" t;="" e++)="" n.css("display")="" !="none" n.hide()="" :="" n.show()="" toggleclass:="" function(e,="" n)="" e,="" "undefined"="" n:="" boolean(n);="" arguments.length="" t.foreach(this,="" function(e)="" e.classname="" });="" "").replace(="" \s+$="" g,="" \s+="" "="" ");="" i.length;="" r++)~="" ("="" ").indexof("="" i[r]="" ")="" typeof="" ").replace("="" ",="" !~="" !0="" ~="" !1="" (t="t.replace(i[r]," ""));="" "")="" function(r,="" i)="" t.dom(r).toggleclass(e.call(r,="" i,="" r.classname),="" })="" this="" void="" (e.mousewheel)="" t.each({="" mouseenter:="" "mouseover",="" mouseleave:="" "mouseout"="" },="" function(n,="" e[n]="{" bindtype:="" pack:="" function(t)="" t.type="n;" (!i="" !r(this,="" i))="" e.apply(this,="" arguments)="" focusin:="" "focus",="" focusout:="" "blur"="" e[t]="{" n,="" attachelements:="" "textarea,select,input,button,a"="" e.mousewheel="{" "dommousescroll":="" "mousewheel",="" t.wheeldelta="t.wheelDelta" (n="" r.detail="" *="" -40="" r.wheeldelta)="" 0,="" (t.event.special),="" triggerhandler:="" !i.triggerdata="" (i.triggerdata="r)," n.call(t,="" undefined,="" (t._util_.eventbase),="" a="{" submit:="" 3,="" focus:="" 2,="" blur:="" f="function(e," t)="" n;="" document.createevent="" n.initevent(e,="" !0,="" !0))="" document.createeventobject="" n.type="e);" (t)="" in="" try="" n[i]="t[i]" catch(s)="" n.extradata="" (n.extradata="r)," r[i]="t[i]" l="function(e," (e.dispatchevent)="" e.dispatchevent(n);="" (e.fireevent)="" e.fireevent("on"="" c="function(e," o)="" u,="" c;="" (u="f(t," r))="" (u.triggerdata="n);" (o)="" i.call(e,="" null,="" u);="" h="e.window" =="=" window="" a[t];="" (h="" &="" !(t="" a))="" u)="" catch(p)="" s(e).triggerhandler(t,="" (c="" 2)="" e[t]()="" {}="" trigger:="" i;="" this.each(function()="" c(this,="" (t._util_.eventbase,="" t.event),="" unbind:="" this.off(e,="" undelegate:="" this.off(t,="" unique:="" t.dom(t.array(this.toarray()).unique(e))="" t._util_.inarray="function(e," (!t)="" -="" 1;="" (r)="" r.call(t,="" n);="" math.max(0,="" 0;="" (;="" n++)="" t[n]="==" val:="" t._util_.support.dom.select.disabled="!0;" "on",="" "checkbox"],="" option:="" get:="" t.specified="" e.value:="" e.text="" select:="" function(n)="" "select-one"="" null:="" [],="" i.length,="" a:="" s:="" l,="" a;="" f++)="" ((l.selected="" s)="" (r="" !l.disabled:="" l.getattribute("disabled")="==" null)="" (!l.parentnode.disabled="" !e.nodename(l.parentnode,="" "optgroup")))="" u.push(c)="" set:="" t.dom(n).find("option").each(function(n,="" r.selected="e.inArray(t.dom(this).val(),">= 0
                                }),
            ...
            t.sio.extend({
                ...
                subByte: function(e, n) {
                    ...
                    if (e < 0 || this.getByteLength() <= e)="" return="" this.valueof();="" var="" r="this.substr(0," e).replace(="" ([^\x00-\xff])="" g,="" "$1="" ").substr(0,="" [^\x00-\xff]$="" ,="" "").replace(="" "$1");="" +="" (n="" ||="" "")="" }="" }),="" t.string.extend({="" tohalfwidth:="" function()="" {="" this.replace(="" [\uff01-\uff5e]="" function(e)="" string.fromcharcode(e.charcodeat(0)="" -="" 65248)="" }).replace(="" \u3000="" "="" ")="" wbr:="" (?:<[^="">]+>)|(?:&#?[0-9a-z]{2,6};)|(.{1})/gi, "$&<wbr>").replace(/><wbr>/g, ">")
                }
            }), t.swf = t.swf || {},
            t.swf.version = function() {
                ...
                v.push("<embed"); var="" g;="" for="" (u="" in="" e)="" {="" f="e[u];" if="" (f="" ||="" !1="" 0)="" ((new="" regexp("^salign$",="" "i")).test(u))="" g="f;" continue="" }="" v.push("="" ",="" u,="" '="', c(f), '" ')="" return="" &&="" v.push('="" salign="', c(g), '" '),=""></embed");></object>"),
                v.join("")
            },
        ...
        t.T = r
    });</=></[^></").replace(></=></body></html></=></a></=></=></=></=></=></$1></([\w:]+)></(?!area|br|col|embed|hr|img|input|link|meta|param)(([\w:]+)[^></=></(\w+)></1)continue;r.push(s)}return></0?this[this.length+e]:this[e]:array.prototype.slice.call(this,0)},toarray:function(){return></\></(\w+)\s*\></t;r++)this[r]=n[r];return></8?s.removeattribute(n):delete>